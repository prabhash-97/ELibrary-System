        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["role"]==null)
                {
                    ...
                    LinkButton8.Visible = false;//publisher managment link button
                    LinkButton9.Visible = false;//book inventory link button
                    LinkButton10.Visible = false;//book issuing link button
                    LinkButton11.Visible = false;//member managment link button
                }
                ...
                else if (Session["role"].Equals("admin"))
                {
                    ...
                    LinkButton8.Visible = true;//publisher managment link button
                    LinkButton9.Visible = true;//book inventory link button
                    LinkButton10.Visible = true;//book issuing link button
                    LinkButton11.Visible = true;//member managment link button
                }
